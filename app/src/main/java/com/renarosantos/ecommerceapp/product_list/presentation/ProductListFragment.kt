...
class ProductListFragment : Fragment() {
    ...
    private val adapter = ProductCardListAdapter(::onItemClicked, ::onWishListClicked)
    ...
    private fun onWishListClicked(viewState: ProductCardViewState){
        viewModel.onWishListClicked(viewState)
    }
}